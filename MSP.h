...
enum {
    SLEEP_STATE_NONE = 0,
    SLEEP_STATE_WAITING,
    SLEEP_STATE_SLEEP_SUMMON,       // sleep summon for ESP
    SLEEP_STATE_IN_SLEEP,           // ESP in sleep
    SLEEP_STATE_NO_SLEEP_NEEDED,    // no sleep today
    SLEEP_STATE_COUNT               // (PRIVATE - FOR SERVICE ONLY) count of elements in SLEEP_STATE
} __sleep_state_type;
